...
python write_offline.py raw_in rop_in con_in inl_in raw_out rop_out con_out inl_out

from a Python interpreter:
import sys
sys.argv = [raw_in, rop_in, con_in, inl_in, raw_out, rop_out, con_out, inl_out]
execfile("write_offline.py")
'''
...
def main():
    ...
    parser = argparse.ArgumentParser(description='Create a new copy of the data for a problem instance, with offline solution as the operating point')
